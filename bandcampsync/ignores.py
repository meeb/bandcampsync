...
class Ignores:
    ...
    def parse_ignores(self):
        ...
        if self.ign_insert_index == -1:
            ...
            self.ign_lines.append("# IDs of items already downloaded will be automatically added below this line.\n")
            self.ign_lines.append("# =========================================================\n")
        ...
        lines = [line.split('#')[0].strip() for line in self.ign_lines] # Strip comments
